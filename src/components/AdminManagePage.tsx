...
const ADMIN_THEME: Record<ThemeColor, AdminTheme> = {
  ...
  green: { shell: 'bg-green-50', accentText: 'text-green-700', accentBg: 'bg-green-200', selectedTab: 'bg-green-200 text-green-950', idleTab: 'bg-green-50 text-slate-700 hover:bg-green-100', statBg: 'bg-green-50', logoColor: 'bg-green-500', softBg: 'bg-green-50/70', focusBorder: 'focus:border-green-200' },
