...
const ADMIN_THEME: Record<ThemeColor, AdminTheme> = {
  ...
  green: { shell: 'bg-lime-50', accentText: 'text-lime-700', accentBg: 'bg-lime-200', selectedTab: 'bg-lime-200 text-lime-950', idleTab: 'bg-lime-50 text-slate-700 hover:bg-lime-100', statBg: 'bg-lime-50', logoColor: 'bg-lime-500', softBg: 'bg-lime-50/70', focusBorder: 'focus:border-lime-200' },
