...
const ADMIN_THEME: Record<ThemeColor, AdminTheme> = {
  blue: { shell: 'bg-sky-50', accentText: 'text-sky-700', accentBg: 'bg-sky-400', selectedTab: 'bg-sky-300 text-sky-950', idleTab: 'bg-sky-50 text-slate-700 hover:bg-sky-100', statBg: 'bg-sky-50', logoColor: 'bg-sky-600', softBg: 'bg-sky-50/70', focusBorder: 'focus:border-sky-300' },
  pink: { shell: 'bg-pink-50', accentText: 'text-pink-700', accentBg: 'bg-pink-300', selectedTab: 'bg-pink-300 text-pink-950', idleTab: 'bg-pink-50 text-slate-700 hover:bg-pink-100', statBg: 'bg-pink-50', logoColor: 'bg-pink-600', softBg: 'bg-pink-50/70', focusBorder: 'focus:border-pink-300' },
  yellow: { shell: 'bg-amber-50', accentText: 'text-amber-700', accentBg: 'bg-amber-300', selectedTab: 'bg-amber-300 text-amber-950', idleTab: 'bg-amber-50 text-slate-700 hover:bg-amber-100', statBg: 'bg-amber-50', logoColor: 'bg-amber-600', softBg: 'bg-amber-50/70', focusBorder: 'focus:border-amber-300' },
  green: { shell: 'bg-emerald-50', accentText: 'text-emerald-700', accentBg: 'bg-emerald-300', selectedTab: 'bg-emerald-300 text-emerald-950', idleTab: 'bg-emerald-50 text-slate-700 hover:bg-emerald-100', statBg: 'bg-emerald-50', logoColor: 'bg-emerald-600', softBg: 'bg-emerald-50/70', focusBorder: 'focus:border-emerald-300' },
  purple: { shell: 'bg-purple-50', accentText: 'text-purple-700', accentBg: 'bg-purple-300', selectedTab: 'bg-purple-300 text-purple-950', idleTab: 'bg-purple-50 text-slate-700 hover:bg-purple-100', statBg: 'bg-purple-50', logoColor: 'bg-purple-600', softBg: 'bg-purple-50/70', focusBorder: 'focus:border-purple-300' },
  ...
  black: { shell: 'bg-slate-100', accentText: 'text-slate-800', accentBg: 'bg-slate-400', selectedTab: 'bg-slate-700 text-white', idleTab: 'bg-slate-50 text-slate-700 hover:bg-slate-200', statBg: 'bg-slate-100', logoColor: 'bg-slate-800', softBg: 'bg-slate-100/80', focusBorder: 'focus:border-slate-400' },
  navy: { shell: 'bg-indigo-50', accentText: 'text-indigo-800', accentBg: 'bg-indigo-300', selectedTab: 'bg-indigo-300 text-indigo-950', idleTab: 'bg-indigo-50 text-slate-700 hover:bg-indigo-100', statBg: 'bg-indigo-50', logoColor: 'bg-indigo-800', softBg: 'bg-indigo-50/70', focusBorder: 'focus:border-indigo-300' },
};
