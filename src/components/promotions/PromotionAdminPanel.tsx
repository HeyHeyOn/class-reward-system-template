...
function parsePromotionListResponse(value: unknown): Promotion[] | null {
...
export function comparePromotions(left: Pick<Promotion, 'sortOrder' | 'promotionId'>, right: Pick<Promotion, 'sortOrder' | 'promotionId'>): number {
  if (left.sortOrder !== right.sortOrder) return left.sortOrder - right.sortOrder;
  return left.promotionId < right.promotionId ? -1 : left.promotionId > right.promotionId ? 1 : 0;
}
